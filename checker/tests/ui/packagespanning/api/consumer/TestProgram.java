...
import api.module.SafeByDecl;
import api.module.UIByPackageDecl;

/*>>> import guitypes.checkers.quals.*;*/

public class TestProgram {
    @SuppressWarnings("static-method") public void
            nonUIStuff(final UIElement e,
        ...
        e.runOnUIThread(new IAsyncUITask() {
            ...
            @Override public void doStuff() { // should inherit UI effect
        ...
        uicons.runAsync(new /*@UI*/IGenericTask() {
            ...
            @Override public void doGenericStuff() { // Should be inst. w/ @UI eff.
                e2.dangerous(); // should be okay
            }
        });
        safecons.runAsync(new /*@AlwaysSafe*/IGenericTask() {
            ...
            @Override public void doGenericStuff() { // Should be inst. w/ @AlwaysSafe
                //:: error: (call.invalid.ui)
        ...
        safecons.runAsync(new /*@UI*/IGenericTask() {
            ...
            @Override public void doGenericStuff() { // Should be inst. w/ @UI
        ...
        safecons.runAsync(new IGenericTask() {
            @Override public void doGenericStuff() {
        ...
        safecons.runAsync(new IGenericTask() {
            ...
            /*@UIEffect*/@Override public void doGenericStuff() {
                UIByPackageDecl.implicitlyUI();
            }
        });
    }
