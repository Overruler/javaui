...
public class MultiQual {
    public static/*@PolyUIType*/interface A {
        public/*@PolyUIEffect*/void mA();
    }

    public static/*@PolyUIType*/interface B {
        public/*@PolyUIEffect*/void mB();
    }

    public static/*@PolyUIType*/interface P {
        public/*@PolyUIEffect*/void mP();
    }

    public static/*@PolyUIType*/interface X {
        public/*@PolyUIEffect*/void mX();
    }
    ...
    public static/*@PolyUIType*/class C implements
    /*@UI*/A, /*@AlwaysSafe*/
    B, /*@PolyUI*/
    P, /*@AlwaysSafe*/
    X {
        // Implement @UI A
        @Override public/*@UIEffect*/void mA() {
            MultiQual.ui_action();
        }

        // Implement @AlwaysSafe B
        @Override public void mB() { // implicitly safe
        }

        // Implement @PolyUI P
        @Override public/*@PolyUIEffect*/void mP() {
        ...
        @Override public/*@UIEffect*/void mX() {
            MultiQual.ui_action();
        }
    }
